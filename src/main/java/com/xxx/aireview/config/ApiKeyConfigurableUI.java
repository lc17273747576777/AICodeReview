...
import com.xxx.aireview.util.PromptDialogUIUtil;
...
public class ApiKeyConfigurableUI {
    ...
    private ComboBox<String> codeTypesComboBox;
    ...
    private void initComponents() {
        ...
        codeTypesComboBox = new ComboBox<>(Constants.codeTypes);
    ...
    private void layoutComponents() {
        ...
        addComponent(new JBLabel("Code type:"), gbc, 0, 4, 0.0);
        addComponent(codeTypesComboBox, gbc, 1, 4, 1.0);

        addComponent(new JBLabel("Prompt type:"), gbc, 0, 5, 0.0);
        addComponent(promptTypeComboBox, gbc, 1, 5, 1.0);
    ...
    private JPanel createCustomPromptPanel() {
        ...
        labelPanel.setBorder(JBUI.Borders.empty(0, 0, 6, 0)); // 添加底部间距
        ...
        JLabel linkLabel = new JLabel(
                "<html><a href=''>More Prompts ↗</a></html>");
    ...
    private JPanel createProjectPromptPanel() {
        ...
        JPanel labelPanel = new JPanel(new BorderLayout());
        labelPanel.setBorder(JBUI.Borders.empty(0, 0, 6, 0));
    ...
    public ComboBox<String> getCodeTypesComboBox() {
        return codeTypesComboBox;
    }
